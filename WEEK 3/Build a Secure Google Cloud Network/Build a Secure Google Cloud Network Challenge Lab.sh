...
# https://www.youtube.com/watch?v=GK3oBOgORbI

# Build and Secure Networks in Google Cloud: Challenge Lab


export IAP_NETWORK_TAG=allow-ssh-iap-ingress-ql-800

export INTERNAL_NETWORK_TAG=allow-ssh-internal-ingress-ql-800

export HTTP_NETWORK_TAG=allow-http-ingress-ql-800
